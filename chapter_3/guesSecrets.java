public class guesSecrets {
    public static void main(String[] args)
		...
		System.out.println("The following must be entered as whole numbers or letters."); // gather data & do some error checking
		if ( oDataStore.mSetAge(oDataStore) ) System.out.println("Error in retrieving age.");
		if ( oDataStore.mSetWeight(oDataStore) ) System.out.println("Error in retrieving weight.");
		if ( oDataStore.mSetMonth(oDataStore) ) System.out.println("Error in retrieving birth month.");
		oDataStore.mGetValuesChec();// do calculations and produce results 
	}
}
class oData 
{ // data class
    ...
    public boolean getter ( oData oInfo ) 
    {
    	// stuff
	return false;
    }
    public boolean mSetWeight ( oData oInfo )
    {
    ...
    public boolean mSetAge ( oData oInfo )
    {
    	boolean bTest=true;
	while (true)
    ...
    public boolean  mSetMonth (oData oInfo) 
    {
	boolean bTest = false; // test var 
